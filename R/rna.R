...
#'
#' @param filter_data RNA Expression Matrix
...
#'
#' @examples
DR_process <- function(file_data,method="RNA_UMAP",n_neighbors=100,min_dist=NULL,
                       center=T,scale=T){
  if(method=="RNA_UMAP"){
    ...
    pca_res <- prcomp(file_data, center = center, scale. = center, rank. = 30)
